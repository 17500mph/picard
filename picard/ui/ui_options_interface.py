...
class Ui_InterfaceOptionsPage(object):
    def setupUi(self, InterfaceOptionsPage):
        ...
        self.use_adv_album_column = QtWidgets.QCheckBox(self.groupBox_2)
        self.use_adv_album_column.setObjectName("Album Column")
        self.vboxlayout1.addWidget(self.use_adv_album_column)
